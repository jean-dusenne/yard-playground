<template>
  <div>
    ...
    <DockZone :layout="dropZoneLayout2" slot-height="4rem" :counter="30" :start="50" dock-name="Dock 002" />
    <DockZone :layout="dropZoneLayout3" slot-height="4rem" :counter="32" :start="80" dock-name="Dock 003" />
    <DockZone :layout="dropZoneLayout4" slot-height="5rem" :counter="20" :start="112" dock-name="Parking" />
